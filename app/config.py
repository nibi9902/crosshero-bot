...
# Cada cicle = WATCH_POLL_SECONDS ± WATCH_POLL_JITTER segons (defaults: 40-70s).
# Aleatoritzem per no ser un patró de tràfic massa robòtic.
WATCH_POLL_SECONDS = int(os.getenv("WATCH_POLL_SECONDS", "55"))
WATCH_POLL_JITTER = int(os.getenv("WATCH_POLL_JITTER", "15"))
